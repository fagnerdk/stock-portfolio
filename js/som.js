...
function resutado(){
    ...
    document.getElementById('soma_totau').innerHTML='R$:'+' '+soma(Number(vl0),Number(vl1),Number(vl2),Number(vl3),Number(vl4),Number(vl5),Number(vl6),Number(vl7),Number(vl8),Number(vl9));
    console.log(vl0)
    console.log(vl1)
   /* console.log(soma)*/
